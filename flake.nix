...

{
  ...
  inputs = {
    ...
    # Zellij integration with the `zellij-autolock` plugin
    plugins-zellij-vim = {
  ...
  outputs = { self, nixpkgs, nixCats, ... }@inputs: let
    ...
    categoryDefinitions = { pkgs, settings, categories, extra, name, mkPlugin, ... }@packageDef: {
      ...
      lspsAndRuntimeDeps = {
        ...
        rust = with pkgs; [ rust-bin.stable.latest.default rust-analyzer vscode-extensions.vadimcn.vscode-lldb.adapter ];
      };

      # This is for plugins that will load at startup without using packadd:
      startupPlugins = {
        required = with pkgs.vimPlugins; [ lze lzextras ];
    ...
    packageDefinitions = {
      ...
      nixCats = {pkgs, name, ... }: {
        ...
        categories = {
          required = true; # Contains plugin loader
          general = true;
          zellij = true;
					snacks = true;
          git = true;
